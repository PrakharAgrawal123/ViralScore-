  ...
  return (
    ...
    >
      ...
      <div style={{ position: "relative", zIndex: 1 }} className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row gap-4 items-stretch md:items-center justify-between mb-8 pb-6 border-b border-white/5">
        ...
        <AnimatePresence mode="popLayout">
          {filteredPosts.length > 0 ? (
            ...
            <motion.div
              ...
              className="rounded-2xl border border-white/10 border-dashed bg-white/5 p-16 text-center max-w-md mx-auto"
            >
